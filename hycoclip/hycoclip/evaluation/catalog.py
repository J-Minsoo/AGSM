...
from torchvision.datasets import Country211, FGVCAircraft, RenderedSST2, StanfordCars

import hycoclip.data.evaluation as DE
...
class DatasetCatalog:
    ...
    CONSTRUCTORS: dict[str, Callable] = {
        ...
        # "cifar10": partial(CIFAR10, download=True),
        ...
        "cars": partial(StanfordCars, download=False),
    ...
    NUM_CLASSES: dict[str, int] = {
        ...
        "mnist": 10, "clevr": 8, "pcam": 2, "sst2": 2, "openimages": 498,
    }
    # fmt: on
